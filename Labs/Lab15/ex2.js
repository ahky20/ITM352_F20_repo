// Exercise 2, code copied from lab14 ProcessLogin.js
...
app.use(session({ secret: "ITM352 rocks!", saveUninitialized: false, resave: false })); // secret is kind of like a password
...
app.get("/set_cookie", function (request, response) {
    ...
    response.cookie('myname', 'Amber Young', { maxAge: 10000 }).send('cookie set');
